    ...
    <section id="contact">
      <div className="container">
        ...
        >
          ...
          <motion.div custom={3} variants={fadeUp} className="contact-wrapper">
            <div className="contact-links">
              ...
              >
                ...
                <div>
                  <p className="contact-link-label">Discord</p>
                  <p className="contact-link-desc">Join the discussion server</p>
                </div>
                <ExternalIcon />
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="contact-link-desc">chenlong@aotur.com</p>
                </div>
              </a>
            </div>

            <div className="contact-qr">
              <img src="/discord-qr.png" alt="Discord QR Code" width="120" height="120" />
              <p className="contact-qr-label">Scan to join Discord</p>
            </div>
          </motion.div>
        </motion.div>
      </div>
